...
public class HeaderSteps {
    ...
    @Step("Проверяем, что кнопка каталога отображается")
    public void checkThatCatalogButtonDisplayed(){
        Assert.assertTrue(header.isCatalogButtonDisplayed());
    }

    @Step("Кликаем на кнопку каталога")
    public void clickCatalogButton(){
        header.clickCatalogButton();
