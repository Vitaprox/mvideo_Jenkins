...
@FindBy(xpath = "//mvid-header-icon-tooltip/div[contains(@class, 'tooltip__item')][.//button[text()=' К списку избранного ']]")
public class WishListTooltipBlock extends AbstractBlock{
    private String XPATH_PRODUCT_CONTAINER = "//div[contains(@class, 'item-wrapper')][.//a[text()='%s']]";
    //div[contains(@class, 'item-wrapper')]//div[@title='Удалить товар']
